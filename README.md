...
test that would have caught one; commons-io saw a 3.2% partial-skip rate on the fallback path (footnote 6) but still
selected at least one killing test for every mutant it caught.
